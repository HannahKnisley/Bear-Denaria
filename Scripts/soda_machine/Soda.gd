...
func _process(delta):
	if buttonDown == true and $/root/WorldRoot/pop_machine/cup.onPlate == true and $/root/WorldRoot/pop_machine/cup.onPlate2 == false and $/root/WorldRoot/pop_machine/cup.countOnPlate1 == 1:
